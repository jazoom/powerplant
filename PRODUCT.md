...
They choose the provider and model on the project desk. They can keep the provider default.
...
- Choose the provider and model on the project desk.
...
- Choose Springfield light or Springfield dark as a preference stored on the local machine.
